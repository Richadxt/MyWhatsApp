...
import com.example.personalwhatsapp.databinding.ActivitySettingsBinding;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.backArrowww.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.saveButon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String username = binding.etUserNamee.getText().toString();
        ...
        database.getReference().child("Users").child(FirebaseAuth.getInstance().getUid())
                        .addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                binding.etUserNamee.setText(users.getUserName());
